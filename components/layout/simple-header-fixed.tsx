...
export function SimpleHeader() {
  ...
  const handleLanguageToggle = () => {
    ...
    setLanguage(newLang)
    localStorage.setItem('harka-language', newLang)
          ...
          <nav className="hidden md:flex items-center space-x-1">
            {visibleItems.map((item) => (
              ...
              >
                ...
                {item.highlight && (
                  <Badge variant="secondary" className="ml-1 text-xs bg-white/20 border-0">
                    FREE
                  </Badge>
                )}
              </Link>
            ...
            <div className="flex flex-col space-y-2">
              {visibleItems.map((item) => (
                ...
                >
                  ...
                  <span>{item.label}</span>
                  {item.highlight && (
                    <Badge variant="secondary" className="ml-auto text-xs bg-white/20 border-0">
                      FREE
                    </Badge>
                  )}
                </Link>
